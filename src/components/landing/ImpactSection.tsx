...
export const ImpactSection: React.FC = () => {
  ...
  return (
    <section className="items-center flex w-full flex-col gap-10 bg-gradient-to-b from-white via-[#C9EDFF] to-white px-0 py-24 max-md:max-w-full">
      ...
      <Carousel
        className="w-[1280px] max-w-full mt-10"
        setApi={setApi}
        opts={{
          loop: true,
          align: "start",
